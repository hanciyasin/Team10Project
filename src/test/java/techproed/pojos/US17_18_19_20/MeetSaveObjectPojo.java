...
public class MeetSaveObjectPojo implements Serializable {
	private int id;
	...
	private List<MeetSaveStudentsPojo> students;

	public MeetSaveObjectPojo() {
	}

	public MeetSaveObjectPojo(int id, String description, String date, String startTime, String stopTime, int advisorTeacherId, String teacherName, String teacherSsn) {
		this.id = id;
	...
	public void setStudents(List<MeetSaveStudentsPojo> students){
		this.students = students;
	}

	public List<MeetSaveStudentsPojo> getStudents(){
		return students;
	}
