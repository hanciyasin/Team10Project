...
public class StudentInfoSavePojo implements Serializable {
	...
	public StudentInfoSavePojo() {
	}

	public StudentInfoSavePojo(int absentee, int educationTermId, double finalExam, String infoNote, int lessonId, double midtermExam, int studentId) {
