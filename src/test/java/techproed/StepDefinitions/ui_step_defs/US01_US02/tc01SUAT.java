...
public class tc01SUAT {
    ...
    @And("cıkan ekranda succesful yazısının göründüğünü doğrula")
    public void cıkanEkrandaSuccesfulYazısınınGöründüğünüDoğrula() {
    }
}
